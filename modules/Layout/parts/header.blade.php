       ...
       ">
                @if(!Auth::check())
                        ...
                        left: 357px;">
                            ...
                            padding: 10px 29px;
                            border-radius: 9px;">{{__('Login')}}</a>
                        </li>
                        @if(is_enable_registration())
                            <li class="signup-item" style="position: relative;
                            left: 345px;">
                                <a href="#register" class="btn btn-primary" style="background: linear-gradient(180deg, #FE9000 0%, #FF3500 100%);color:white;  border-radius: 9px;" data-toggle="modal" data-target="#register" class="signup">{{__('Sign Up')}}</a>
                            </li>
                        @endif
                    @else
