...
Route::get('/daily-deals','HotelController@dailyhotelfunction')->name('hotel.admin.dailyhotel');
Route::get('/best-deals','HotelController@besthotelfunction')->name('hotel.admin.besthotel');
Route::get('/mobile-banner','HotelController@mobilebannerpanel')->name('hotel.admin.banner');
Route::get('/visa','HotelController@visafunction')->name('admin.visa');
Route::post('/banner','HotelController@bannerupload')->name('hotel.admin.upload');
Route::get('/fetchbanner','HotelController@getbanner')->name('hotel.admin.bannerget');
Route::post('/updatebanner','HotelController@updatebanner')->name('hotel.admin.updateslider');
Route::post('/deletebanner','HotelController@deletebanner')->name('hotel.admin.deleteslider');



Route::post('/addbesttodayhotel','HotelController@besttodayhotel')->name('hotel.admin.besttoday');
Route::post('/updateaddbesttodayhotel','HotelController@updatebesttodayhotel')->name('hotel.admin.updatebesttoday');
Route::post('/deleteaddbesttodayhotel','HotelController@deletebesttodayhotel')->name('hotel.admin.deletebesttoday');
