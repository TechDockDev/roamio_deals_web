...
//                    $query->update(['status' => $action]);
    ...
    public function besthotelfunction()
    {

     $data = DB::table('bravo_hotels')->whereNotNull('bannerImage')->get();
     $location = DB::table('bravo_locations')->get();

      return view('Hotel::admin.besthotel',compact('data','location'));

    }


    public function dailyhotelfunction()
    {
        

         return view('Hotel::admin.dailyhotel');
    }

    public function mobilebannerpanel()
    {
       $data = DB::table('sliderbanner')->where('condition','hotel')->get();
      return view('Hotel::admin.banner',compact('data'));

    }

    public function visafunction(){

        return view('Hotel::admin.visa');
    }

    public function bannerupload(request $request)
    {

             $productImage = date('mdYHis').uniqid().'.'.$request->bannerImage->extension();
      
             $request->bannerImage->move(public_path('image'),$productImage);


              DB::table('sliderbanner')->insert([

                    'bannerImage' =>'/image/'.$productImage,
                    'link' =>$request->link,
                    "condition" =>"hotel"
    ...
    public function updatebanner(request $request)
    {
     ...
     if($request->bannerImage !== null)
     {
        ...
        $rules = array(
            'bannerImage' => 'nullable|image|mimes:jpeg,jpg,png,gif|max:200',
            );
    ...
    if ($validator->fails())
    {
        return redirect()->back()->withErrors($validator);
             ...
             DB::table('sliderbanner')->where('id',$id)->update([
                    ...
                    return redirect()->back()->with('bannerupdated','your banner picture is updated');
                ...
                return redirect()->back()->with('bannerupdated','your banner detail is updated');
          }
   ...
   public function deletebanner(request $request)
   {
               ...
               $id = $request->id;
                ...
                DB::table('sliderbanner')->where('id',$id)->delete();

                return redirect()->back()->with('bannerdeleted','your banner is deleted');

   }


   public function besttodayhotel(request $request)
   {
 ...
 $rules = array(
   ...
   public function updatebesttodayhotel(request $request)
   {
 ...
 $rules = array(
    ...
    if ($validator->fails())
    {
       ...
       DB::table('bravo_hotels')->where('id',$id)->update([
                ...
                return redirect()->back()->with('hotelupdated','hotel added successfully');
     }else{
 ...
 DB::table('bravo_hotels')->where('id',$id)->update([
   ...
   public function deletebesttodayhotel(request $request)
  {

       $id = $request->id;
       
       DB::table('bravo_hotels')->where('id',$id)->delete();
       
       return redirect()->back()->with('datadeleted','hotel deleted successfully');
