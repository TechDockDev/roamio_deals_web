            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="time" value="{{$row->check_in_time}}" placeholder="{{__("Eg: 12:00AM")}}" name="check_in_time" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__("Time for check out")}}</label>
                        <input type="time" value="{{$row->check_out_time}}" placeholder="{{__("Eg: 11:00AM")}}" name="check_out_time" class="form-control">
                    </div>
                </div>
            </div>
            @if(is_default_lang())
            ...
            @if(is_default_lang())
                ...
                <div class="row">
                    <div class="col-lg-6">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group">
                            <label class="control-label">{{__("Discount Percent")}}</label>
                            <input type="number" step="any" min="0" name="discount_percent" class="form-control" value="<?php if($discount_percent !== null ){ echo $discount_percent->discount_percent;} ?>" placeholder="{{__("Hotel Price")}}">
                        </div>
                    </div>
