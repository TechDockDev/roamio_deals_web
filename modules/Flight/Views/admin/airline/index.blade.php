...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Airline: :name",['name'=>@$row->code])}}</h1>
        </div>
        @include('admin.message')
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    <div class="panel-title">{{__("Add Visa")}}</div>
                    <div class="panel-body">
                        <form action="{{route('flight.admin.airline.store',['id'=>$row->id??-1])}}" method="post">
                            @csrf
                            @include('Flight::admin.airline.form')
                            <div class="">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{route('flight.admin.airline.bulkEdit')}}" class="filter-form filter-form-left d-flex justify-content-start">
                                {{csrf_field()}}
                    ...
                    <div class="col-left">
                        <form method="get" action="{{route('flight.admin.airline.index')}} " class="filter-form filter-form-right d-flex justify-content-end" role="search">
