...
Route::get('/termsvisa','FlightController@termcondition')->name('flight.admin.terms');


Route::post('/visaupdate','FlightController@updatetermscondition')->name('flight.admin.visaTerms');
...
Route::get('/deleteentry/{id}','FlightController@deleteentry')->name('flight.admin.delete');

Route::post('/store','FlightController@store')->name('flight.admin.store');

Route::post('/store','FlightController@store')->name('flight.admin.store');


Route::post('entry','FlightController@addentry')->name('flight.admin.entry');

Route::post('update_visa','FlightController@updateVisa')->name('flight.admin.update');


Route::post('deleteVisa','FlightController@deleteVisa')->name('flight.admin.Visadelete');
