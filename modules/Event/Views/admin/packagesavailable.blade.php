...
@section ('content')
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Price Availability Calendar")}}</h1>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row form_modal_calendar form-horizontal" novalidate onsubmit="return false">
                        ...
                        <div class="col-md-6" v-show="form.active">
                            <div class="form-group">
                                <label >{{__('Number of Packages')}}</label>
    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
			...
			calendar = new FullCalendar.Calendar(calendarEl, {
				...
				events:{
                url:"{{route('event.admin.package.availability.loadDates',['event_id'=>$hotel->id])}}",
						extraParams:{
							id:lastId,
                        }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'{{route('event.admin.package.availability.store',['event_id'=>$hotel->id])}}',
                        data:this.form,
                        dataType:'json',
                        method:'post',
