    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            ...
            <div class="title-actions">
                @if(empty($recovery))
                <a href="{{route('event.admin.create')}}" class="btn btn-primary">{{__("Add new Activities")}}</a>
                @endif
            </div>
        </div>
                        ...
                        @if($rows->total() > 0)
                            @foreach($rows as $row)
                                <tr class="{{$row->status}}">
                                    ...
                                    <td>
                                        @if(empty($recovery))
                                            <a href="{{route('event.admin.edit',['id'=>$row->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> {{__('Edit')}}</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
