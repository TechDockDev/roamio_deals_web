            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" min="0" name="price" class="form-control" value="{{$row->price}}" placeholder="{{__("Activities Price")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("discount %")}}</label>
                        <input type="number" step="any" name="discount" class="form-control" value="{{$row->discount}}" placeholder="{{__("Activities Sale Price")}}">
