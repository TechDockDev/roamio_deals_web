            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" min="0" name="price" class="form-control" value="<?php echo e($row->price); ?>" placeholder="<?php echo e(__("Activities Price")); ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("discount %")); ?></label>
                        <input type="number" step="any" name="discount" class="form-control" value="<?php echo e($row->discount); ?>" placeholder="<?php echo e(__("Activities Sale Price")); ?>">
        ...
        <div class="form-group-item <?php if(!is_default_lang()): ?> d-none <?php endif; ?>" data-condition="enable_extra_price:is(1)">
            ...
            <div class="g-items-header">
                <div class="row">
                    ...
                    <div class="col-md-2"><?php echo e(__('Person')); ?></div>
                    <div class="col-md-1"></div>
                </div>
            </div>
            <div class="g-items">
                    ...
                    <?php $__currentLoopData = $row->extra_price; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$extra_price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item" data-number="<?php echo e($key); ?>">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                           <select name="extra_price[<?php echo e($key); ?>][person]" class="form-control" <?php if(!is_default_lang()): ?> disabled <?php endif; ?>>
                                                <option <?php if($extra_price['person'] ==  'adult'): ?> selected <?php endif; ?> value="adult"><?php echo e(__("adult")); ?></option>
                                                <option <?php if($extra_price['person'] ==  'child'): ?> selected <?php endif; ?> value="child"><?php echo e(__("child")); ?></option>
                                            </select> 
...
<?php endif; ?>
<?php /**PATH /home/u533143048/domains/techdocklabs.com/public_html/roamiodeals/modules/Event/Views/admin/event/pricing.blade.php ENDPATH**/ ?>