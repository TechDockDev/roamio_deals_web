<?php if(is_default_lang()): ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="time" value="<?php echo e($row->check_in_time); ?>" placeholder="<?php echo e(__("Eg: 12:00AM")); ?>" name="check_in_time" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label><?php echo e(__("Time for check out")); ?></label>
                        <input type="time" value="<?php echo e($row->check_out_time); ?>" placeholder="<?php echo e(__("Eg: 11:00AM")); ?>" name="check_out_time" class="form-control">
                    </div>
                </div>
            </div>
            <?php if(is_default_lang()): ?>
    ...
    <div class="panel">
        <?php
        $discount_percent = DB::table('bravo_hotels')->where('id',$row->id)->select('discount_percent')->first();
       ?>
        ...
        <div class="panel-body">
            <?php if(is_default_lang()): ?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group">
                            <label class="control-label"><?php echo e(__("Discount Percent")); ?></label>
                            <input type="number" step="any" min="0" name="discount_percent" class="form-control" value="<?php if($discount_percent !== null ){ echo $discount_percent->discount_percent;} ?>" placeholder="<?php echo e(__("Hotel Price")); ?>">
                        </div>
                    </div>
            ...
            <div class="g-items-header">
                <div class="row">
                    ...
                    <div class="col-md-2"><?php echo e(__('Discount')); ?></div>
                     <div class="col-md-2"><?php echo e(__("Shift")); ?></div>
                    ...
                    <?php $__currentLoopData = $row->extra_price; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$extra_price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item" data-number="<?php echo e($key); ?>">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input type="number" <?php if(!is_default_lang()): ?> disabled <?php endif; ?>  name="extra_price[<?php echo e($key); ?>][price]" class="form-control" value="<?php echo e($extra_price['price']); ?>">
                                </div>
                                <div class="col-md-2">
                                    <input type="number" name="extra_price[<?php echo e($key); ?>][discount]" class="form-control" value="<?php echo e($extra_price['discount']); ?>">
                                </div>
                                
                    
                                 <div class="col-md-2">
                                    <select name="extra_price[<?php echo e($key); ?>][shift]" class="form-control" <?php if(!is_default_lang()): ?> disabled <?php endif; ?>>
                                        <option <?php if($extra_price['shift'] ==  'night'): ?> selected <?php endif; ?> value="night"><?php echo e(__("night")); ?></option>
                                            <!--<option <?php if($extra_price['shift'] ==  'day'): ?> selected <?php endif; ?> value="day"><?php echo e(__("day")); ?></option>-->
                                    </select> 
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" __name__="extra_price[__number__][discount]" class="form-control" value="">
                                ...
                                <option value="night"><?php echo e(__("night")); ?></option>
                                 </select> 
                                 </div>
...
<?php endif; ?>
<?php /**PATH /home/u533143048/domains/techdocklabs.com/public_html/roamiodeals/modules/Hotel/Views/admin/hotel/pricing.blade.php ENDPATH**/ ?>