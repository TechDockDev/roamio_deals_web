...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('location.admin.store',['id'=>($row->location_id) ? $row->location_id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"><?php echo e($row->location_id ? 'Edit: '.$row->name : __("Add new location")); ?></h1>
                    <?php if($row->slug): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u533143048/domains/techdocklabs.com/public_html/roamiodeals/modules/Location/Views/admin/detail.blade.php ENDPATH**/ ?>