                ...
                <?php if(!Auth::check()): ?>
                        ...
                        <?php if(is_enable_registration()): ?>
                            <li class="signup-item">
                                <a href="#register" class="btn btn-primary" style="background: linear-gradient(180deg, #FE9000 0%, #FF3500 100%);color:white;" data-toggle="modal" data-target="#register" class="signup"><?php echo e(__('Sign Up')); ?></a>
                            </li>
                        <?php endif; ?>
                    <?php else: ?>
