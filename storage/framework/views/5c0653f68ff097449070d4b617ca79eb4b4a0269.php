...
<div class="container mt-3">
    ...
    <div class="row mb-4">
      ...
      <?php if(count($rows) > 0): ?>
      <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wishlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="col-md-4">
              <div class="card" style="border-radius: 10px;">
                  
                   <div class="Daily-Deals1" style="position: relative;">
                    <img src="<?php echo e($wishlist['service']['image']); ?>" style="height:200px; width:100%; border-radius: 10px;">
                  ...
                  <div class="card-body">
                      <h5 class="card-title"><?php echo e($wishlist['service']['title']); ?></h5>
                      <p class="card-text">
                          <span><i class="fa fa-map-marker" aria-hidden="true"></i>
                          <?php echo e($wishlist['service']['location']['name']); ?></p></span>
                      <p>
                          <span class="btn btn-light Daily-btn">4.2 </span> (4)
                          </span><span> Excellent </span>
                      </p>
                      <p>
                          <span style="font-size: 25px; color: black;"><?php echo e($wishlist['service']['price']); ?></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\komal\OneDrive\Desktop\roamiodeals_T\roamiodeals\themes/BC/Hotel/Views/frontend/wishlist-list.blade.php ENDPATH**/ ?>