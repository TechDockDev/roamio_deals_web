        ...
        <div class="col-md-4">
            <div class="card" style="border-radius: 10px;">
                <div class="Daily-Deals1" style="position: relative;">
                    <img src="<?php echo e($wishlist['file_path']); ?>" style="height:200px; width:100%; border-radius: 10px;">
                ...
                <div class="card-body">
                    ...
                    <p>
                        <span style="font-size: 25px; color: black;"><?php echo e($wishlist['hotel']->price); ?></span>
