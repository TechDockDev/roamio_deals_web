                    ...
                    <form action="<?php echo e(route('review.store')); ?>" class="needs-validation" novalidate method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="user_id" style="display:none;" value="<?php echo e(Auth::id()); ?>">
...
<?php endif; ?>
<?php /**PATH /home/u533143048/domains/techdocklabs.com/public_html/roamiodeals/themes/BC/Review/Views/frontend/form.blade.php ENDPATH**/ ?>