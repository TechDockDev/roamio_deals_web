                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="event_layout_search" class="form-control" >
                                <option value="normal" <?php echo e(($settings['event_layout_search'] ?? '') == 'normal' ? 'selected' : ''); ?>><?php echo e(__("Normal Layout")); ?></option>
                                <option value="map" <?php echo e(($settings['event_layout_search'] ?? '') == 'map' ? 'selected' : ''); ?>><?php echo e(__('Map Layout')); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
...
<?php /**PATH /home/u533143048/domains/techdocklabs.com/public_html/roamiodeals/modules/Event/Views/admin/settings/event.blade.php ENDPATH**/ ?>