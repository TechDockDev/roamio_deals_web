...
<div class="header-logo flex-shrink-0">
    <h3 class="logo-text"><a href="<?php echo e(route('admin.index')); ?>"><img src="http://127.0.0.1:8000/uploads/0000/1/2023/05/11/logo.png" style="width: 68%;
    height: 43px;
    position: relative;
    left: -13px;"></a></h3>
</div>
...
<?php /**PATH C:\Users\komal\OneDrive\Desktop\roamiodeals_T\roamiodeals\modules/Layout/admin/parts/header.blade.php ENDPATH**/ ?>