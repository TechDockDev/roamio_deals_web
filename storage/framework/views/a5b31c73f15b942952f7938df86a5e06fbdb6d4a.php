...
<div class="container mt-5">
   <div class="row">
      <h4 class="title mx-2" style="margin-top: 43px;font-weight:700; font-size:28px;">Best Deal On Staycation <a href="<?php echo e(url('staycation')); ?>"><span style="font-size:15px; font-weight: 900; float:right;color:#FF3500; ">View All</span></a></h4>
   </div>
   <div class="row">
      ...
      <div class="col-md-4 mb-3">
        <a href="<?php echo e(url('/staycation/' . $hotelx->slug)); ?>" style="text-decoration:none;"> <div class="card mb-2" style="border-radius: 10px; position: relative; height:95%; border-radius: 20px;">
            <div class="Daily-Deals1" style="position: relative;">
               <img src="<?php echo e($hotelx->banner_image); ?>" style="height:200px; width:100%; border-radius: 20px;">
            ...
            <div class="card-body">
               ...
               <p>
                  <span style="font-size:25px; color:black; font-weight:600;"><?php echo e($hotelx->price); ?></span>
                  <span style="font-size:25px;"> AED </span>
                  <span class="btn btn-light Daily-btn" style="margin-top: -10px;"><?php echo e($hotelx->discount_percent); ?>% OFF</span>
               </p>
            </div>
         </div></a>
      </div>
...
<div class="container mt-5">
   <div class="row">
      <h4 class="title mx-2" style="margin-top: 43px; font-weight:700; font-size:28px;">Budget Staycation <a href="<?php echo e(url('staycation')); ?>"><span style="font-size:15px; font-weight: 900; float:right;color:#FF3500; ">View All</span></a></h4>
   </div>
   <div class="row">
      ...
      <div class="col-md-4 mb-3">
          <a href="<?php echo e(url('/staycation/' . $hotelx->slug)); ?>" style="text-decoration:none;">
...
<div class="container">
   ...
   <div class="container mt-5">
      <div class="row">
         <h4 class="title mx-2" style="margin-top: 43px; font-weight:700; font-size:28px;">Explore Staycation <a href="<?php echo e(url('staycation')); ?>"><span style="font-size:15px; font-weight: 900; float:right;color:#FF3500; ">View All</span></a></h4>
      </div>
      <div class="row">
         ...
         <div class="col-md-4 mb-3">
            <a href="<?php echo e(url('/staycation/' . $hotelx->slug)); ?>" style="text-decoration:none;"> <div class="card mb-3" style="border-radius: 10px;  position: relative; height:93%;border-radius: 20px;">
               <div class="Daily-Deals1" style="position: relative;">
               <img src="<?php echo e($hotel->bannerImage); ?>" style="height:200px; width:100%; border-radius: 20px;">
               ...
               <div class="card-body">
                  ...
                  <p>
                     <span style="font-size:25px; color:black; font-weight:500"><?php echo e($hotel->price); ?></span>
                     <span style="font-size:25px;"> AED </span>
                     <span class="btn btn-light Daily-btn" style="margin-top:-10px;"><?php echo e($hotel->discount_percent); ?>% OFF</span>
                  </p>
               </div>
            </div></a>
         </div>
