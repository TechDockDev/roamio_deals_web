        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                <div class="bravo-filter-price">
                    ...
                    <button type="submit" class="btn btn-link btn-apply-price-range" style="color:#FF3500;"><?php echo e(__("APPLY")); ?></button>
                </div>
            </div>
        </div>
        <div class="g-filter-item">
                ...
                <div class="g-filter-item">
                    ...
                    <div class="item-content">
                        ...
                        <?php if(count($item->terms) > 3 and empty($selected)): ?>
                            <button type="button" class="btn btn-link btn-more-item" style="color:#FF3500"><?php echo e(__("More")); ?> <i class="fa fa-caret-down"></i></button>
                        <?php endif; ?>
                    </div>
                </div>
             <?php endif; ?>
...
<?php /**PATH C:\Users\komal\OneDrive\Desktop\roamiodeals_T\roamiodeals\themes/BC/Hotel/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>