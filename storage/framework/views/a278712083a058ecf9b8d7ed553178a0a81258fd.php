...
>
       ...
       $user_id = null;
           ...
           $cartdata = DB::table('cart')->where('user_id',$user_id)->where('status',Null)->get();
              ...
              <div class="col-md-12">
                <a href="<?php echo e(url('hotel-wish-list')); ?>"><p style="color:#CDCFD0;left: 314px; position:relative; top:-22px; font-size:15px; font-weight:600;"><span><i class="fa fa-heart-o" aria-hidden="true" style=" font-size:20px;"></i></span>&nbsp;   WishList</p></a>
               ...
               <?php if(!Auth::check()): ?>
                       ...
                       <?php if(is_enable_registration()): ?>
                           <li class="signup-item">
                               <a href="#register" class="btn btn-primary" style="background: linear-gradient(180deg, #FE9000 0%, #FF3500 100%);color:white; border-radius: 10px;" data-toggle="modal" data-target="#register" class="signup"><?php echo e(__('Sign Up')); ?></a>
                           </li>
                       <?php endif; ?>
                   <?php else: ?>
