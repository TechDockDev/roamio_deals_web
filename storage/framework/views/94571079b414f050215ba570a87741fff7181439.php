    ...
    <div class="container mt-5">
        <?php $__currentLoopData = $dataff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dealydeal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="row">
                ...
                margin-bottom: 27px;"><?php echo e($dealydeal['parent_name']); ?> <span style="float:right; color:#FF3500; font-size:15px;">View All</span></h4>
            </div>
            <div class="row">
   ...
   <?php endif; ?>
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row">
            ...
            margin-bottom: 27px;"><?php echo e($datas['parent_name']); ?></h4>
        </div>
        <div class="row">
