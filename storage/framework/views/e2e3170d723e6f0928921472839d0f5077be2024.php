        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    <h1 class="title-bar"><?php echo e($row->id ? __('Edit: ').$row->title : __('Add new Staycation')); ?></h1>
                    <?php if($row->slug): ?>
                ...
                <div class="">
                    ...
                    <?php endif; ?>
                    <?php if($row->slug): ?>
                        <a class="btn btn-primary btn-xs" href="<?php echo e($row->getDetailUrl(request()->query('lang'))); ?>" target="_blank"><?php echo e(__("View Staycation")); ?></a>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <?php if(is_default_lang()): ?>
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label><?php echo e(__('Staycation Featured')); ?></label>
                                        <br>
                                        <label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\komal\OneDrive\Desktop\roamiodeals_T\roamiodeals\modules/Hotel/Views/admin/detail.blade.php ENDPATH**/ ?>