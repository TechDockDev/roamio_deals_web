<form class="bravo-form-login" method="POST" action="<?php echo e(route('login')); ?>">
    ...
    <div class="form-group">
        <p> By signing up, you’re agree to our <span style="color:#FF3500;">Terms & Conditions</span> and <span style="color:#FF3500;" >Privacy Policy</span></p>
        </div>
...
<?php /**PATH C:\Users\komal\OneDrive\Desktop\roamiodeals_T\roamiodeals\modules/Layout/auth/login-form.blade.php ENDPATH**/ ?>