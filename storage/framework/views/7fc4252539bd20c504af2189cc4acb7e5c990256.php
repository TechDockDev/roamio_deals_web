       ...
       $user_id = null;
           ...
           $cartdata = DB::table('cart')->where('user_id',$user_id)->where('status',Null)->get();
             ...
             top: -67px; font-size:15px; font-weight:600;"><span>
                    <img src="<?php echo e(url('images/cart.png')); ?>" style="height: 25px;
                    position: relative;
                    left: 6px;">
               ...
               <?php if(!Auth::check()): ?>
                   ...
                   <?php else: ?>
                       ...
                       <li class="login-item dropdown ">
                           <a href="#" data-toggle="dropdown"  class="login btn btn-light" style="background: linear-gradient(180deg, #FE9000 0%, #FF3500 100%);color:white; border-radius: 10px;     position: relative;   top: -8px; "><?php echo e(__("Hi, :name",['name'=>Auth::user()->getDisplayName()])); ?>
...
</div><?php /**PATH D:\new_roamio\roamio_deals_web\modules/Layout/parts/header.blade.php ENDPATH**/ ?>