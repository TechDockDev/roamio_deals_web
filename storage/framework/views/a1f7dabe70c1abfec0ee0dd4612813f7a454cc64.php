                 ...
                 <div class="col-md-4 mb-3"> <a href="<?php echo e(url('/staycation/' . $hotel->slug)); ?>"
                         ...
                         <div class="card mb-3"
                             ...
                             <div class="Daily-Deals1" style="position: relative;">
                                 ...
                                 <input type="text" class="objectmodalgetclass<?php echo e($hotel->id); ?>"
                                     style="display:none;" name="object_model" value="hotel">
                                 <span
                                     class="fa fa-heart-o fa-3x fass newhotelheartstatus<?php echo e($hotel->id); ?> hotelwishlistaddingheart <?php if ($hotel->wishlist == true) {
                                         echo 'class';
                                     } else {
                                         echo '';
                                     } ?>"
                                     attr="<?php echo e($hotel->id); ?>"
                     ...
                     <?php $__currentLoopData = $top_discount['hotels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <div class="card mb-3 h-100"
                             ...
                             <div class="Daily-Deals1" style="position: relative;">
                                 ...
                                 <input type="text" class="objectidgetclass<?php echo e($hotel->id); ?>"
                                     style="display: none;" name="object_id" value="<?php echo e($hotel->id); ?>">
                                 <input type="text" class="objectmodalgetclass<?php echo e($hotel->id); ?>"
                                     style="display: none;" name="object_model" value="hotel">
                                 <span
                                     class="fa fa-heart fa-3x fass newhotelheartstatus<?php echo e($hotel->id); ?> hotelwishlistaddingheart <?php if ($hotel->wishlist == true) {
                                         echo 'class';
                                     } ?>"
                                     attr="<?php echo e($hotel->id); ?>"
                                     style="position: absolute;
...
<?php /**PATH D:\new_roamio\roamio_deals_web\themes/BC/Hotel/Views/frontend/blocks/list-hotel/index.blade.php ENDPATH**/ ?>