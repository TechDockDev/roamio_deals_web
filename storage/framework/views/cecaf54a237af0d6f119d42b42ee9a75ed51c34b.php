<form class="form bravo-form-register" method="post" action="<?php echo e(route('auth.register.store')); ?>">
    ...
    <div class="c-grey f14 text-center">
       <?php echo e(__(" Already have an account?")); ?>
        ...
        <a href="#" data-target="#login" data-toggle="modal" style="color:#FF3500;"><?php echo e(__("Log In")); ?></a>
    </div>
</form>
<?php /**PATH C:\Users\komal\OneDrive\Desktop\roamiodeals_T\roamiodeals\modules/Layout/auth/register-form.blade.php ENDPATH**/ ?>