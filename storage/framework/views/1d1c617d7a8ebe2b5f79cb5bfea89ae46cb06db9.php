<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Activities Content")); ?></strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label><?php echo e(__("Title")); ?></label>
            <input type="text" value="<?php echo clean($translation->title); ?>" placeholder="<?php echo e(__("Name of the event")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<?php /**PATH /home/u533143048/domains/techdocklabs.com/public_html/roamiodeals/modules/Event/Views/admin/event/content.blade.php ENDPATH**/ ?>