...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(!empty($recovery) ? __('Recovery') : __("All Staycation")); ?></h1>
            <div class="title-actions">
                <?php if(empty($recovery)): ?>
                <a href="<?php echo e(route('hotel.admin.create')); ?>" class="btn btn-primary"><?php echo e(__("Add new Staycation")); ?></a>
                <?php endif; ?>
            </div>
        </div>
                                        ...
                                        <?php if(empty($recovery)): ?>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="<?php echo e(route('hotel.admin.edit',['id'=>$row->id])); ?>"><?php echo e(__("Edit Staycation")); ?></a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\komal\OneDrive\Desktop\roamiodeals_T\roamiodeals\modules/Hotel/Views/admin/index.blade.php ENDPATH**/ ?>