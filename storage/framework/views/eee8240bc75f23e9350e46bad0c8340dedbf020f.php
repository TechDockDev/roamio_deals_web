    ...
    <div class="row">
        <div class="col-md-2">
            <div class="card" style="border-radius:10px;">
                <img src="<?php echo e(asset('images\benner-img.png')); ?>" alt="" srcset="" style="width:100%;height:150px; border-radius:10px;">
            </div>
            </div>  
        <div class="col-md-2" >
            <div class="card" style="border-radius:10px;">
...
<div class="container mt-5">
   <div class="row">
    <h4  class="title mx-3" style="margin-top:43px;">Dubai Package Deals</h4> 
   </div>
   <div class="row">
        <div class="col-md-4">
            <div class="card"  style="border-radius: 10px;">
...
<div class="container mt-5">
 ...
 <div class="container mt-5">
    <div class="row">
     <h4  class="title mx-3" style="margin-top:43px;">Combo Deals</h4> 
    </div>
    <div class="row">
         <div class="col-md-4">
             <div class="card"  style="border-radius: 10px;">
