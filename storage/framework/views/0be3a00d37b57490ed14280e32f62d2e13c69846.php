            ...
            <div class="service-review-pc">
                <div class="head">
                    <div class="left">
                        ...
                        <span class="text-rating" style="color:#FF3500;"><?php echo e(__(":number reviews",['number'=>$reviewData['total_review']])); ?></span>
                    </div>
                    <div class="score" style="background:#FF3500;">
                        <?php echo e($reviewData['score_total']); ?><span style="background:#FF3500;">/5</span>
                    </div>
                </div>
            </div>
        <?php endif; ?>
...
<?php /**PATH C:\Users\komal\OneDrive\Desktop\roamiodeals_T\roamiodeals\themes/BC/Hotel/Views/frontend/layouts/search/loop-list.blade.php ENDPATH**/ ?>