<div class="item">
    ...
    <div class="mb-4">
        <div class="input-group border-bottom-1">
            ...
            <input type="text" class="form-control font-weight-bold font-size-16 shadow-none hero-form font-weight-bold border-0 p-0 font-size-14" placeholder="{{__("Search for...")}}" value="" readonly>
        </div>
    </div>
</div>